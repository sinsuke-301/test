        ...
        success: function (response) {
            ...
            for (var i = 0; i < music_name.length; i++) {
                ...
                music_name[i].onclick = function () {
                    ...
                    window.sessionStorage.setItem('song_id', id_box[num]);
                    window.sessionStorage.setItem('index', num);
...
forward.addEventListener("click", function () {
    ...
    window.sessionStorage.setItem('song_id', id_box[count]);
    window.sessionStorage.setItem('index', count);
    location.assign('play.html');
});
    ...
    $ajax({
        ...
        success: function (response) {
            ...
            for (var i = 0; i < review_str.length; i++) {
                ...
                var review = review_box.querySelectorAll('.review');
            ...
            if (!review_str.length) {
                for (var j = 0; j < 15; j++) {
                    review[j].style.display = 'none';
                }
            }
            else {
                for (var j = review_str.length; j < 15; j++) {
                    review[j].style.display = 'none';
                }
            }
        }
